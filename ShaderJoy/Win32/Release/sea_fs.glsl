...
#define EPSILON_NRM (0.1 / screen_resolution.x)
#define AA
...
#define SEA_TIME (1.0 + global_time * SEA_SPEED)
...
vec3 getPixel(in vec2 coord, float time) {    
    vec2 uv = coord / screen_resolution.xy;
    uv = uv * 2.0 - 1.0;
...
void main()
{
	...
	vec2 fragCoord = gl_FragCoord.xy;
	 ...
	 float time = global_time * 0.3 + mouse_position.x*0.01;
